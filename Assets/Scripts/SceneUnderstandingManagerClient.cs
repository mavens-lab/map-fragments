...
namespace Microsoft.MixedReality.SceneUnderstanding.Samples.Unity
{
    ...
    public class SceneUnderstandingManagerClient : MonoBehaviour
    {
        ...
        public List<AURORA_GameObject> SceneRootList = new List<AURORA_GameObject>();
...
#pragma warning restore CS4014
            ...
            foreach (Scene suScene in suScenes)
            {
                if (suScene != null)
                {
                    ...
                    if (sceneToUnityTransformAsMatrix4x4 != null)
                    {
                        ...
                        //SceneRootList.Add(CreateAuroraSceneObject()); //JZ: removing this step decreased latency. 593
        ...
        private void OrientSceneForPC(AURORA_GameObject sceneRoot, SceneUnderstanding.Scene suScene)
        {
            if (suScene == null)
            {
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        //private AURORA_GameObject CreateAuroraSceneObject()
        //{

        //    Debug.Log("OnPointerClicked");

        //    var newobject = m_auroraProxy.PrimaryAuroraContext.Spawn(m_Prefab.SpawnableTypeUuid, Vector3.zero);
        //    newobject.AURORA_Object.ObjectSpawnSuccessfulHandler += TakeOwnershipAfterSpawn; //lambda function?
        ...
        //    //m_metadataFieldStringInterface.AutoPublishUpdates = true;
        //    //JC: gives error about ownership not set yet
        //    // call publish method

        //    //SceneRootList.Add(newobject);
        ...
        //    return newobject;
        //}
        //JZ: commented out the above cause Aurora functions are no longer needed
    }
